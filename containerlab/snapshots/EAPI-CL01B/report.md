...
----------- ---------- ---------- ------------------- --------- --------------- 
192.168.0.2 3090416073 1599028502                  NA multihop  08/27/21 17:14  
192.168.0.3 3780853764 2978021091                  NA multihop  08/27/21 17:14  
...
Neighbor Status Codes: m - Under maintenance
  ...
  EAPI-RS01                192.168.0.2      4 65000           3366      3770    0    0 18:11:00 Estab   79     79
  EAPI-RS02                192.168.0.3      4 65000           3144      3918    0    0 18:10:55 Estab   79     79
```
## show bgp evpn
 ...
 *  ec   RD: 192.168.255.10:11 ip-prefix 1.1.1.0/24
                                 192.168.254.9         -       100     0       65000 65105 ?
 * >     RD: 192.168.255.12:11 ip-prefix 1.1.1.0/24
                                 -                     -       100     0       65000 65105 ?
 ...
 *       RD: 192.168.255.12:11 ip-prefix 10.1.10.0/24
                                 -                     -       100     0       ?
 * >     RD: 192.168.255.12:11 ip-prefix 10.1.10.1/32
                                 -                     -       100     0       65000 65101 ?
 * >     RD: 192.168.255.12:11 ip-prefix 10.1.10.2/32
                                 -                     -       100     0       65000 65102 ?
 ...
 * >     RD: 192.168.255.12:11 ip-prefix 10.1.12.0/24
                                 -                     -       100     0       65000 65101 ?
 * >     RD: 192.168.255.12:11 ip-prefix 10.1.12.2/32
                                 -                     -       100     0       65000 65102 ?
...
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor         V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  EAPI-CL01A               172.31.253.18    4 65106           4309      4326    0    0    2d12h Estab   23     23
  EAPI-SPINE1_Ethernet10   172.31.255.36    4 65001           4332      4320    0    0    2d12h Estab   19     19
  EAPI-SPINE2_Ethernet10   172.31.255.38    4 65001           4312      4294    0    0    2d12h Estab   19     19

BGP summary information for VRF CENTRAL_ROUTING
Router identifier 192.168.255.12, local AS number 65106
Neighbor Status Codes: m - Under maintenance
  Neighbor         V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  172.31.253.18    4 65106           4300      4300    0    0    2d12h Estab   3      3

BGP summary information for VRF TENANT_A_PROJECT01
Router identifier 192.168.255.12, local AS number 65106
Neighbor Status Codes: m - Under maintenance
  Neighbor         V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  172.31.253.18    4 65106           6333      6333    0    0    2d12h Estab   12     12
```
...
Gateway of last resort is not set
 ...
 B E      1.1.1.0/24 [20/0] via VTEP 192.168.254.9 VNI 11 router-mac 0e:1d:c0:25:65:41 local-interface Vxlan1
 B E      10.1.10.1/32 [20/0] via VTEP 192.168.254.3 VNI 11 router-mac 0e:1d:c0:f0:bd:d1 local-interface Vxlan1
 B E      10.1.10.2/32 [20/0] via VTEP 192.168.254.5 VNI 11 router-mac 0e:1d:c0:a3:43:e0 local-interface Vxlan1
 ...
 B E      10.1.12.2/32 [20/0] via VTEP 192.168.254.5 VNI 11 router-mac 0e:1d:c0:a3:43:e0 local-interface Vxlan1
...
```
Last table change time   : 2 days, 1:58:02 ago
...
----    -----------       ----        -----      -----   ---------
 110    5001.0002.f6c5    DYNAMIC     Vx1        1       1:22:57 ago
 110    5001.0056.2a6e    DYNAMIC     Vx1        1       2:04:20 ago
 110    5001.0068.b446    STATIC      Po3
 301    5001.0068.b446    STATIC      Po3
 302    5001.0068.b446    STATIC      Po3
 302    5001.0073.5ad7    DYNAMIC     Vx1        1       1:59:05 ago
 302    5001.00bf.cca4    DYNAMIC     Vx1        1       1:59:04 ago
1196    0c1d.c0d2.9e98    DYNAMIC     Vx1        1       18:11:13 ago
1196    0c1d.c0e4.777b    DYNAMIC     Vx1        1       18:11:13 ago
1196    0e1d.c025.6541    DYNAMIC     Vx1        1       18:11:12 ago
1196    0e1d.c0a3.43e0    DYNAMIC     Vx1        1       18:11:06 ago
1196    0e1d.c0f0.bdd1    DYNAMIC     Vx1        1       18:11:12 ago
...
Peer State                      :                primary
State changes                   :                      2
Last state change time          :   2 days, 12:57:23 ago
Hardware ready                  :                   True
Failover                        :                  False
...
Heartbeats sent/received        :            54852/54851
Peer monotonic clock offset     :     151.141995 seconds
...
Uptime: 2 days, 12 hours and 59 minutes
Total memory: 2006804 kB
Free memory: 1000432 kB
```
## show vlan
...
----  -----------     ----      ---  ----             -----   ---------
 110  5001.0002.f6c5  EVPN      Vx1  192.168.254.5    1       1:22:52 ago
 110  5001.0056.2a6e  EVPN      Vx1  192.168.254.3    1       2:04:15 ago
 302  5001.0073.5ad7  EVPN      Vx1  192.168.252.2    1       1:59:00 ago
 302  5001.00bf.cca4  EVPN      Vx1  192.168.252.3    1       1:59:00 ago
1196  0c1d.c0d2.9e98  EVPN      Vx1  192.168.254.8    1       18:11:08 ago
1196  0c1d.c0e4.777b  EVPN      Vx1  192.168.254.7    1       18:11:08 ago
1196  0e1d.c025.6541  EVPN      Vx1  192.168.254.9    1       18:11:07 ago
1196  0e1d.c0a3.43e0  EVPN      Vx1  192.168.254.5    1       18:11:01 ago
1196  0e1d.c0f0.bdd1  EVPN      Vx1  192.168.254.3    1       18:11:08 ago
...
VNI       VLAN       VRF                      Source        
--------- ---------- ------------------------ ------------  
11        1196       TENANT_A_PROJECT01       evpn          
13        1197       CENTRAL_ROUTING          evpn
```
## show vxlan vtep
