...
--------------- ------------------- ----------- ------------- --------- ------- 
Management1     10.73.254.42/24     up          up              1500            
Vlan110         10.1.10.2/24        up          up              1500            
Vlan112         10.1.12.2/24        up          up              1500            
Vlan201         10.2.1.2/24         up          up              1500
```
## show lldp neighbors

```
Last table change time   : 2 days, 2:52:10 ago
...
! device: SRV-POD02 (vEOS, EOS-4.24.0F)
!
...
Hardware version:    
Serial number:       
System MAC address:  5001.0002.f6c5
